...
if (!defined('_DESIGNER_FUNCTIONS')) {
    ...
    $GLOBALS['designer_settings'] = array(
        'data' => '',
        'vmenu' => array('show_submenus' => true, 'simple' => false),
        'active_paginator' => 'common',
        'is_preview' => false,
        'current_theme_path' => $templatePath,
        'category_layout_type' => isset($_COOKIE['layoutType']) ? $_COOKIE['layoutType'] : 'grid',
        'category_layout_items' => isset($_COOKIE['layoutItemsInRow']) ? $_COOKIE['layoutItemsInRow'] : '',
        'category_layout_count' => 0,
    ...
    {
        $filePath = $GLOBALS['designer_settings']['current_theme_path'] .
            '/' . $folder . '/' . $name . '.php';
    ...
    function addThemeVersion($url) {
        return $url . "?version=1.0.402";
    }

    function buildDataPositionAttr($name)
    {
        return $GLOBALS['designer_settings']['is_preview'] ? 'data-position=' . $name : '';
    }
    ...
    function getCurrentTemplateByType($templateType)
    {
        ...
        if (0 == count(array_diff_assoc($currentItemTypes, $activeItemTypes))
        ...
        $defaultTemplate = '';
        $editor = $GLOBALS['designer_settings']['is_preview'] ? '/editor' : '';
    ...
    $GLOBALS['designer_settings']['currentTemplate'] = getCurrentTemplateByType('default');
